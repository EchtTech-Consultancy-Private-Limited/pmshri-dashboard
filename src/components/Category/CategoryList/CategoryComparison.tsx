import { getComparisonCategoryWiseData } from 'src/actions/dpgi.action';
...
const CategoryComparison = (props: any) => {
    const { state, catId, years } = props
    const dispatch = useDispatch()
    const data = useSelector<StoreModel>(store => store.comparisonCategoryWiseData) as InitialStateModel
    ...
    useEffect(() => {
        dispatch(getComparisonCategoryWiseData(withComparedYear, year, state, catId))
    }, [year, state, catId])
